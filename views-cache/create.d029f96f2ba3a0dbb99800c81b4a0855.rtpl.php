<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="container container-create">
  <div class="row m-auto">
    <div class="col-md-5">
      <form role="form form-c" action="/create" method="POST">
        ...
        <div class="form-group">
          <input type="submit" class="btn btn-dark outline form-control col-md-12">
        </div>     
       </form>
    </div>
    <div class="col-md-7">  

      <img src="/assets/assets/img.jpg" alt="">
